...
Проект перешел от монолитного приложения к модульной структуре. Пользовательское окружение разделено на независимые бинарники, каждый из которых работает в собственной песочнице:

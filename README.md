...
Мы приветствуем Pull Requests и форки проекта! 

Если вы хотите присоединиться к разработке, форкнуть проект для создания собственной ОС на базе seL4 или просто ищете шпаргалку по настройке Git и SSH-ключей для GitHub, пожалуйста, ознакомьтесь с нашим руководством:

👉 **[ЧИТАТЬ CONTRIBUTING.md](CONTRIBUTING.md)**
```
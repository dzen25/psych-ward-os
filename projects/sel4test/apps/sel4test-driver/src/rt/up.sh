#!/bin/bash
# ==============================================================================
# Psych Ward OS - Disk Updater Script
# Автоматизирует копирование свежесобранных ELF-бинарников в образ FAT32
#
# ПРЕДНАЗНАЧЕНИЕ:
# Этот скрипт предназначен для запуска из папки 'build'.
# Он использует относительные пути и создает временную точку монтирования,
# что делает его безопасным и переносимым.
#
# ИСПОЛЬЗОВАНИЕ:
# 1. cd /path/to/psych-ward-os/build
# 2. sudo ./up.sh
# ==============================================================================
...
# --- ОТНОСИТЕЛЬНЫЕ ПУТИ (БЕЗ ХАРДКОДА) ---

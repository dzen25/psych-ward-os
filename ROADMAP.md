...
<details>
<summary><b>Фаза 2 — Извлечение адресов под свои драйверы (клик, чтобы развернуть)</b></summary>
...
<details>
<summary><b>Фаза 3 — Порт дерева `psych-ward-os` (клик, чтобы развернуть)</b></summary>
